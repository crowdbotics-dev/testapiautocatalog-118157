...
## Project Structure
    ...
    ├── testapiautocatalog_118157  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_118157`
...
2. Clone this repo and `cd testapiautocatalog_118157`
